-- Alta interna: sólo un propietario de plataforma puede crear un tenant y
-- enlazar al propietario real sin convertirse en miembro del restaurante.
...
revoke execute on function public.provision_platform_tenant(
  text, text, public.app_locale, text, text, text, text, text, text, text, text, text
) from public, anon;
grant execute on function public.provision_platform_tenant(
  text, text, public.app_locale, text, text, text, text, text, text, text, text, text
) to authenticated;