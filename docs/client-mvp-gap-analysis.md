...
| Reserva pública sin cuenta                    | A medias                               | Fecha, personas, zona, disponibilidad, contacto, comentario, privacidad, confirmación automática, recordatorio 24 h y enlace de gestión; correos activos                                                                    | Completar validación final, rate limit y condiciones/privacidad versionadas                                           |
...
3. Confirmaciones y recordatorio 24 h ya activos; completar cancelación/modificación, rate limit y consentimientos versionados.
