...
El producto tiene una base sólida para tenancy, autenticación, reservas, plano de sala, servicio, cuentas, TPV y facturación, pero no cumple todavía el MVP completo descrito por el cliente. Las brechas principales restantes son la certificación operativa, validaciones externas de fiscalidad/control horario y algunas políticas de privacidad o proveedores.
...
| --------------------------------------------- | ---------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| Catálogo: categorías, productos, precios, IVA | Hecho en núcleo / A medias en validación | Catálogo con modificadores auditados, disponibilidad y precios efectivos por local/canal con fallback global                                                                                                                                                                                               | Validación visual final y operación con datos del restaurante                                    |
...
| Comandas                                      | Hecho en núcleo / A medias en validación | TPV unificado: cuenta por mesa, líneas, notas, estación, edición rápida de cantidad/notas, estado persistido y altas idempotentes con cola offline                                                                                                                                                         | Smoke operativo y trazabilidad avanzada                                                          |
...
| Cobros y facturación del restaurante          | Hecho en núcleo / A medias en validación | TPV: pagos por método/división, pagos mixtos atómicos e idempotentes, tarjeta manual online, devoluciones, descuentos auditados y ticket imprimible desde web                                                                                                                                              | Validación fiscal/contable y documentos externos                                                 |
| Caja y arqueo                                 | Hecho en núcleo / A medias en validación | TPV para responsables: apertura, entradas/salidas, arqueos con notas y diferencias, cierres, histórico, conciliación por local y devoluciones en efectivo                                                                                                                                                  | Validación operativa de cierres                                                                  |
...
| Informes                                      | Hecho en núcleo / A medias en validación | Informe de ventas/IVA/método/producto/ticket medio, descuentos, devoluciones, propinas, pagos mixtos, cierres y conciliaciones; filtros y exportación CSV                                                                                                                                                  | Validación de criterios contables y smoke con restaurante                                        |
...
| Control horario                               | Hecho en núcleo / A medias en validación | Terminal compartido online, portal personal, PIN bcrypt, límites de intentos, eventos append-only encadenados, cola offline personal idempotente, cambios de centro con histórico, informe avanzado por empleado/local, exportación CSV y cálculo indicativo de nocturnidad, jornadas partidas y descansos | Validación formal con asesoría, formato de inspección/nómina y política de conservación          |
...
2. Comandas con notas, envío a cocina/barra, estados de preparación, edición rápida y reimpresión web. El núcleo está implementado; falta smoke operativo.
3. Cuenta dividida, descuentos auditados, pagos mixtos atómicos, devoluciones y ticket web ya implementados.
4. Caja: apertura, movimientos, arqueos, diferencias, conciliación avanzada, histórico e informe financiero. El núcleo está implementado; falta validación contable.
...
3. La sincronización offline personal, los informes laborales avanzados y los cambios de centro ya están implementados; queda validar reglas, conservación y formato de inspección/nómina con asesoría. El terminal compartido con PIN requiere red por diseño.
