-- Repara el despliegue de la bóveda VERI*FACTU.
-- La migración original comparte versión con otra migración y puede no haberse
-- aplicado, aunque la aplicación ya consulte estas columnas y esta función.
